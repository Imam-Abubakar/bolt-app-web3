...
const style = {
  wrapper: `h-16 w-full bg-[#34d186] text-white flex md:justify-around items-center px-60 fixed z-20`,
  leftMenu: `flex gap-3`,
  ...
  return (
    <div className={style.wrapper}>
      <div className={style.leftMenu}>
        ...
        <Image src={boltLogo}  height={47} width={80} />
        </div>
        <div className={style.menuItem}>Rides</div>
        <div className={style.menuItem}>About</div>
        <div className={style.menuItem}>More</div>
      </div>
      <div className={style.rightMenu}>
        <div className={style.menuItem}>Become a driver</div>
